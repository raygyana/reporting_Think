import {
  Directive, EventEmitter, HostBinding, Input, Output, TemplateRef, OnInit, OnDestroy, ElementRef, Renderer
} from '@angular/core';
...
export class TabDirective implements OnInit, OnDestroy {
  ...
  /** if true tab can be hidable, additional button will appear */
  @Input() public hidable: boolean;
  /** if true tab can be hideTab, additional button will appear */
  @Input() public hideTab: boolean;
