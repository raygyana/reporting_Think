...
import {Constants} from '../../pages/shared/constant';
import {BaseService} from '../../core/base/base.service';

@Injectable()
export class RecordDataTableService extends BaseService {
    ...
    data: Array<any> = [{
        ...
        'records': [
            ['87001', 'Tracy Townsend', '1. Pharmacy Department', 'East Surrey Hospital', 'tracy.townsend@sash.nhs.uk', '', '', '', 'Redhill', '', 'RH1 5RH', ''],
            ['87002', 'Tracy Townup', '2. Pharmacy Lib', 'North Surrey Hospital', 'tracy.townsend@sash.nhs.ru', '', '', '', 'Bluehill', '', 'RH1 5RH', ''],
            ['87003', 'Tracy Towndown', '3. Pharmacy Store', 'South Surrey Hospital', 'tracy.townsend@sash.nhs.cz', '', '', '', 'Tophill', '', 'RH1 5RH', ''],
            ['87004', 'Tracy Townsend', '1. Pharmacy Department', 'East Surrey Hospital', 'tracy.townsend@sash.nhs.uk', '', '', '', 'Redhill', '', 'RH1 5RH', ''],
            ['87005', 'Tracy Townup', '2. Pharmacy Lib', 'North Surrey Hospital', 'tracy.townsend@sash.nhs.ru', '', '', '', 'Bluehill', '', 'RH1 5RH', ''],
            ['87006', 'Tracy Towndown', '3. Pharmacy Store', 'South Surrey Hospital', 'tracy.townsend@sash.nhs.cz', '', '', '', 'Tophill', '', 'RH1 5RH', ''],
            ['87007', 'Tracy Townsend', '1. Pharmacy Department', 'East Surrey Hospital', 'tracy.townsend@sash.nhs.uk', '', '', '', 'Redhill', '', 'RH1 5RH', ''],
            ['87008', 'Tracy Townup', '2. Pharmacy Lib', 'North Surrey Hospital', 'tracy.townsend@sash.nhs.ru', '', '', '', 'Bluehill', '', 'RH1 5RH', ''],
            ['87009', 'Tracy Towndown', '3. Pharmacy Store', 'South Surrey Hospital', 'tracy.townsend@sash.nhs.cz', '', '', '', 'Tophill', '', 'RH1 5RH', ''],
            ['87010', 'Tracy Townsend', '1. Pharmacy Department', 'East Surrey Hospital', 'tracy.townsend@sash.nhs.uk', '', '', '', 'Redhill', '', 'RH1 5RH', ''],
            ['87011', 'Tracy Townup', '2. Pharmacy Lib', 'North Surrey Hospital', 'tracy.townsend@sash.nhs.ru', '', '', '', 'Bluehill', '', 'RH1 5RH', ''],
            ['87012', 'Tracy Towndown', '3. Pharmacy Store', 'South Surrey Hospital', 'tracy.townsend@sash.nhs.cz', '', '', '', 'Tophill', '', 'RH1 5RH', ''],
            ['87013', 'Tracy Townsend', '1. Pharmacy Department', 'East Surrey Hospital', 'tracy.townsend@sash.nhs.uk', '', '', '', 'Redhill', '', 'RH1 5RH', ''],
            ['87014', 'Tracy Townup', '2. Pharmacy Lib', 'North Surrey Hospital', 'tracy.townsend@sash.nhs.ru', '', '', '', 'Bluehill', '', 'RH1 5RH', ''],
            ['87015', 'Tracy Towndown', '3. Pharmacy Store', 'South Surrey Hospital', 'tracy.townsend@sash.nhs.cz', '', '', '', 'Tophill', '', 'RH1 5RH', ''],
            ['87016', 'Tracy Townsend', '1. Pharmacy Department', 'East Surrey Hospital', 'tracy.townsend@sash.nhs.uk', '', '', '', 'Redhill', '', 'RH1 5RH', ''],
            ['87017', 'Tracy Townup', '2. Pharmacy Lib', 'North Surrey Hospital', 'tracy.townsend@sash.nhs.ru', '', '', '', 'Bluehill', '', 'RH1 5RH', ''],
            ['87018', 'Tracy Towndown', '3. Pharmacy Store', 'South Surrey Hospital', 'tracy.townsend@sash.nhs.cz', '', '', '', 'Tophill', '', 'RH1 5RH', ''],
            ['87019', 'Tracy Townsend', '1. Pharmacy Department', 'East Surrey Hospital', 'tracy.townsend@sash.nhs.uk', '', '', '', 'Redhill', '', 'RH1 5RH', ''],
            ['87020', 'Tracy Townup', '2. Pharmacy Lib', 'North Surrey Hospital', 'tracy.townsend@sash.nhs.ru', '', '', '', 'Bluehill', '', 'RH1 5RH', '']
        ]
    }];
    ...
    setRecordDataTableServiceURL(newServiceURL: string) {
