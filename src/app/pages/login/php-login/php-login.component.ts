...
@Component({
  selector: 'app-php-login',
  template: commonHtml(),
  styleUrls: ['./php-login.component.css']
})
export class PhpLoginComponent extends LoginCoreComponent implements OnInit {
  loginImgUrl = './assets/php/images/phppress-logo.png';
  constructor(protected loaderService: LoaderService,
    ...
    if (this.myClientServices.loginUrl === 'demo') {
      this.loginImgUrl = './assets/demo/images/Think-logo-black.png'
    }
