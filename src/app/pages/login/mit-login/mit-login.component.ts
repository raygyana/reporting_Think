...
@Component({
  selector: 'app-mit-login',
  template: commonHtml(),
  styleUrls: ['./mit-login.component.css']
})
export class MitLoginComponent extends LoginCoreComponent implements OnInit {
  loginImgUrl = './assets/mit/images/mitpress-logo.png';
