...
export const ucpNav = [{
      ...
      {
            title: 'Detail Circ. excld Pack',
            fafa: 'fa fa-angle-right',
            routerLink: ['think/detail_circ_excld_report'],
            disabled: false,
            visible: true,
      },
      {
            title: 'Detail Circulation For UCP Pack',
            fafa: 'fa fa-angle-right',
            routerLink: ['think/detail_circ_ucp_pack'],
            disabled: false,
            visible: true,
      },
      {
      ...
      },
      {
            ...
            title: 'Gratis Orders',
            fafa: 'fa fa-angle-right',
            routerLink: ['think/gratis_orders'],
            disabled: false,
            visible: true,
      }, {
            title: 'Gift Orders',
            fafa: 'fa fa-angle-right',
            routerLink: ['think/gift_orders'],
            disabled: false,
            visible: true,
      }]
},
{
      ...
      children: [{
            ...
            children: [{
                  title: 'Detailed Sales Summary Search ',
                  fafa: 'fa fa-angle-right',
      ...
      id: 'headingSalesSubMenu',
      childId: 'ytdSubMenu2',
      childIdHash: '#ytdSubMenu2',
      disabled: false,
      visible: true,
      children: [{
            title: 'YTD Amount by Start Year',
            fafa: 'fa fa-angle-right',
            routerLink: ['think/ytd_amount_by_start_year'],
            disabled: false,
            visible: true,
      }, {
            title: 'YTD Orders by Start Year',
            fafa: 'fa fa-angle-right',
            routerLink: ['think/ytd_orders_by_start_year'],
            disabled: false,
            visible: true,
      }, {
            title: 'YTD Orders by Customer',
            fafa: 'fa fa-angle-right',
            routerLink: ['think/ytd_orders_by_customer'],
            disabled: false,
            visible: true,
      }]
}, {
